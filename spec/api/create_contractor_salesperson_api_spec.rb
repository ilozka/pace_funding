...
# Unit tests for PaceFunding::CreateContractorSalespersonApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateContractorSalespersonApi' do
  before do
    # run before each test
    @instance = PaceFunding::CreateContractorSalespersonApi.new
  end
  ...
  describe 'test an instance of CreateContractorSalespersonApi' do
    it 'should create an instact of CreateContractorSalespersonApi' do
      expect(@instance).to be_instance_of(PaceFunding::CreateContractorSalespersonApi)
    end
  end
