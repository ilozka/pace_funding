...
# Unit tests for PaceFunding::PostUnderwritingResultApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostUnderwritingResultApi' do
  before do
    # run before each test
    @instance = PaceFunding::PostUnderwritingResultApi.new
  end
  ...
  describe 'test an instance of PostUnderwritingResultApi' do
    it 'should create an instact of PostUnderwritingResultApi' do
      expect(@instance).to be_instance_of(PaceFunding::PostUnderwritingResultApi)
    end
  end
