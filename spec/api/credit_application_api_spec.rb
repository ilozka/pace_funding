...
# Unit tests for PaceFunding::CreditApplicationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreditApplicationApi' do
  before do
    # run before each test
    @instance = PaceFunding::CreditApplicationApi.new
  end
  ...
  describe 'test an instance of CreditApplicationApi' do
    it 'should create an instact of CreditApplicationApi' do
      expect(@instance).to be_instance_of(PaceFunding::CreditApplicationApi)
    end
  end
