...
module PaceFunding
  class PostUnderwritingResultApi
    ...
    def post_fni_result_post_with_http_info(auth_key, project_id, fni_status, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PostUnderwritingResultApi.post_fni_result_post ..."
      end
      # verify the required parameter 'auth_key' is set
      fail ArgumentError, "Missing the required parameter 'auth_key' when calling PostUnderwritingResultApi.post_fni_result_post" if auth_key.nil?
      # verify the required parameter 'project_id' is set
      fail ArgumentError, "Missing the required parameter 'project_id' when calling PostUnderwritingResultApi.post_fni_result_post" if project_id.nil?
      # verify the required parameter 'fni_status' is set
      fail ArgumentError, "Missing the required parameter 'fni_status' when calling PostUnderwritingResultApi.post_fni_result_post" if fni_status.nil?
      # verify enum value
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PostUnderwritingResultApi#post_fni_result_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
