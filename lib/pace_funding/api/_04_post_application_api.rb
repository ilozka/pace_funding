  ...
  class 04PostApplicationApi
    ...
    def post_application_post_with_http_info(auth_key, contractor_code, salesperson_code, project_id, notify_url, property_type, property_ownership, fo_first_name, fo_last_name, fo_ssn, fo_dob, fo_email, fo_phone, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: 04PostApplicationApi.post_application_post ..."
      end
      # verify the required parameter 'auth_key' is set
      fail ArgumentError, "Missing the required parameter 'auth_key' when calling 04PostApplicationApi.post_application_post" if auth_key.nil?
      # verify the required parameter 'contractor_code' is set
      fail ArgumentError, "Missing the required parameter 'contractor_code' when calling 04PostApplicationApi.post_application_post" if contractor_code.nil?
      # verify the required parameter 'salesperson_code' is set
      fail ArgumentError, "Missing the required parameter 'salesperson_code' when calling 04PostApplicationApi.post_application_post" if salesperson_code.nil?
      # verify the required parameter 'project_id' is set
      fail ArgumentError, "Missing the required parameter 'project_id' when calling 04PostApplicationApi.post_application_post" if project_id.nil?
      # verify the required parameter 'notify_url' is set
      fail ArgumentError, "Missing the required parameter 'notify_url' when calling 04PostApplicationApi.post_application_post" if notify_url.nil?
      # verify the required parameter 'property_type' is set
      fail ArgumentError, "Missing the required parameter 'property_type' when calling 04PostApplicationApi.post_application_post" if property_type.nil?
      # verify the required parameter 'property_ownership' is set
      fail ArgumentError, "Missing the required parameter 'property_ownership' when calling 04PostApplicationApi.post_application_post" if property_ownership.nil?
      # verify the required parameter 'fo_first_name' is set
      fail ArgumentError, "Missing the required parameter 'fo_first_name' when calling 04PostApplicationApi.post_application_post" if fo_first_name.nil?
      # verify the required parameter 'fo_last_name' is set
      fail ArgumentError, "Missing the required parameter 'fo_last_name' when calling 04PostApplicationApi.post_application_post" if fo_last_name.nil?
      # verify the required parameter 'fo_ssn' is set
      fail ArgumentError, "Missing the required parameter 'fo_ssn' when calling 04PostApplicationApi.post_application_post" if fo_ssn.nil?
      # verify the required parameter 'fo_dob' is set
      fail ArgumentError, "Missing the required parameter 'fo_dob' when calling 04PostApplicationApi.post_application_post" if fo_dob.nil?
      # verify the required parameter 'fo_email' is set
      fail ArgumentError, "Missing the required parameter 'fo_email' when calling 04PostApplicationApi.post_application_post" if fo_email.nil?
      # verify the required parameter 'fo_phone' is set
      fail ArgumentError, "Missing the required parameter 'fo_phone' when calling 04PostApplicationApi.post_application_post" if fo_phone.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: 04PostApplicationApi#post_application_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
