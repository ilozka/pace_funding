...
module PaceFunding
  class ProjectCurrentStatusApi
    ...
    def check_project_status_post_with_http_info(auth_key, contractor_code, salesperson_code, project_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'auth_key' when calling ProjectCurrentStatusApi.check_project_status_post" if auth_key.nil?
      # verify the required parameter 'contractor_code' is set
      fail ArgumentError, "Missing the required parameter 'contractor_code' when calling ProjectCurrentStatusApi.check_project_status_post" if contractor_code.nil?
      # verify the required parameter 'salesperson_code' is set
      fail ArgumentError, "Missing the required parameter 'salesperson_code' when calling ProjectCurrentStatusApi.check_project_status_post" if salesperson_code.nil?
      # verify the required parameter 'project_id' is set
      fail ArgumentError, "Missing the required parameter 'project_id' when calling ProjectCurrentStatusApi.check_project_status_post" if project_id.nil?
      # resource path
