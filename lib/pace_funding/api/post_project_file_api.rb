...
module PaceFunding
  class PostProjectFileApi
    ...
    def post_project_file_post_with_http_info(auth_key, contractor_code, salesperson_code, project_id, type, file, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'auth_key' when calling PostProjectFileApi.post_project_file_post" if auth_key.nil?
      # verify the required parameter 'contractor_code' is set
      fail ArgumentError, "Missing the required parameter 'contractor_code' when calling PostProjectFileApi.post_project_file_post" if contractor_code.nil?
      # verify the required parameter 'salesperson_code' is set
      fail ArgumentError, "Missing the required parameter 'salesperson_code' when calling PostProjectFileApi.post_project_file_post" if salesperson_code.nil?
      # verify the required parameter 'project_id' is set
      fail ArgumentError, "Missing the required parameter 'project_id' when calling PostProjectFileApi.post_project_file_post" if project_id.nil?
      # verify the required parameter 'type' is set
      fail ArgumentError, "Missing the required parameter 'type' when calling PostProjectFileApi.post_project_file_post" if type.nil?
      # verify the required parameter 'file' is set
      fail ArgumentError, "Missing the required parameter 'file' when calling PostProjectFileApi.post_project_file_post" if file.nil?
      # resource path
