...
module PaceFunding
  class PostProjectCancellationFormApi
    ...
    def post_project_cancellation_post_with_http_info(auth_key, contractor_code, salesperson_code, project_id, file, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'auth_key' when calling PostProjectCancellationFormApi.post_project_cancellation_post" if auth_key.nil?
      # verify the required parameter 'contractor_code' is set
      fail ArgumentError, "Missing the required parameter 'contractor_code' when calling PostProjectCancellationFormApi.post_project_cancellation_post" if contractor_code.nil?
      # verify the required parameter 'salesperson_code' is set
      fail ArgumentError, "Missing the required parameter 'salesperson_code' when calling PostProjectCancellationFormApi.post_project_cancellation_post" if salesperson_code.nil?
      # verify the required parameter 'project_id' is set
      fail ArgumentError, "Missing the required parameter 'project_id' when calling PostProjectCancellationFormApi.post_project_cancellation_post" if project_id.nil?
      # verify the required parameter 'file' is set
      fail ArgumentError, "Missing the required parameter 'file' when calling PostProjectCancellationFormApi.post_project_cancellation_post" if file.nil?
      # resource path
