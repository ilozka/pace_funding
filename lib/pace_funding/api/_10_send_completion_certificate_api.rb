...
module PaceFunding
  class 10SendCompletionCertificateApi
    ...
    def send_completion_certificate_post_with_http_info(auth_key, contractor_code, salesperson_code, project_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: 10SendCompletionCertificateApi.send_completion_certificate_post ..."
      end
      # verify the required parameter 'auth_key' is set
      fail ArgumentError, "Missing the required parameter 'auth_key' when calling 10SendCompletionCertificateApi.send_completion_certificate_post" if auth_key.nil?
      # verify the required parameter 'contractor_code' is set
      fail ArgumentError, "Missing the required parameter 'contractor_code' when calling 10SendCompletionCertificateApi.send_completion_certificate_post" if contractor_code.nil?
      # verify the required parameter 'salesperson_code' is set
      fail ArgumentError, "Missing the required parameter 'salesperson_code' when calling 10SendCompletionCertificateApi.send_completion_certificate_post" if salesperson_code.nil?
      # verify the required parameter 'project_id' is set
      fail ArgumentError, "Missing the required parameter 'project_id' when calling 10SendCompletionCertificateApi.send_completion_certificate_post" if project_id.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: 10SendCompletionCertificateApi#send_completion_certificate_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
